...
with st.container():
    ...
    st.markdown('''<img src = "https://github.com/Yadav-Roshan/Bank_Marketing/blob/main/Deployment_test/images/header_new.png?raw=true" width = 1370 height = 320>''', unsafe_allow_html=True)
