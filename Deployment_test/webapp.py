...
if(selected == "Home"):
    with st.container():
        st.markdown('''<img src = "https://raw.githubusercontent.com/Yadav-Roshan/Bank_Marketing/main/Deployment_test/images/homepage.webp" width=1275 style = "border: 2px solid black; border-radius: 5px">''', unsafe_allow_html = True)
