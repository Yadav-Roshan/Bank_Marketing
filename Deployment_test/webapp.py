...
with st.container():
    ...
    st.markdown('''<img src = "https://github.com/Yadav-Roshan/Bank_Marketing/blob/main/Deployment_test/images/header_new.png?raw=true" width = 1275 height = 320>''', unsafe_allow_html=True)
...
if(selected == "Home"):
    with st.container():
        st.markdown('''<img src = "https://raw.githubusercontent.com/Yadav-Roshan/Bank_Marketing/main/Deployment_test/images/homepage.webp" width=1275 style = "-webkit-box-shadow: 0 28px 16px -26px rgba(0, 0, 0);-moz-box-shadow: 0 28px 16px -26px rgba(0, 0, 0);box-shadow: 0 28px 16px -26px rgba(0, 0, 0)">''', unsafe_allow_html = True)
