...
with st.container():
    ...
    st.markdown('''<img src = "https://github.com/Yadav-Roshan/Bank_Marketing/blob/main/Deployment_test/images/header_new.png?raw=true" width = 1275 height = 320 style = "border: 10px black; border-radius: 20%">''', unsafe_allow_html=True)
