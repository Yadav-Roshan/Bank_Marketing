...
with st.container():
    ...
    st.markdown('''<center><img  align="middle" src = "https://github.com/Yadav-Roshan/Bank_Marketing/blob/main/Deployment_test/images/header_new.png?raw=true" width = 1700 height = 400></center>''', unsafe_allow_html=True)
...
selected = option_menu(None, ["Home", "Prediction",  "Analysis", "Contribute", 'About Us'], 
    ...
    styles={
        "container": {"padding": "0!important", "background-color": "#9d0208", "width" : "2000px"},
